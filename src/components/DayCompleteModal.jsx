...
export default function DayCompleteModal({ todayKey, completedDays, kids, onClose, onSpinWheel }) {
  ...
  return (
    <motion.div
      ...
      style={{ background: 'radial-gradient(ellipse at center, #059669 0%, #1d4ed8 55%, #0f0524 100%)' }}>
      ...
      <motion.div className="mb-10"
        ...
        <WeekTracker completedDays={completedDays} todayKey={todayKey} animateToday size="lg" />
      </motion.div>

      {allWeekDone ? (
        <motion.button onClick={onSpinWheel}
          ...
          animate={{ boxShadow: ['0 0 15px rgba(255,200,0,0.4)', '0 0 45px rgba(255,200,0,1.0)', '0 0 15px rgba(255,200,0,0.4)'] }}
        ...
        <motion.button onClick={onClose}
          ...
          whileTap={{ scale: 0.92 }} initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }}
